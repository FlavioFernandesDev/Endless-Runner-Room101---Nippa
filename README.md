...
São usadas as teclas A e D para mover, respectivament para o lado esquerdo e lado direito. Para saltar utiliza-se a tecla de espaço (SPACEBAR).
...
Física: Uso de Rigidbody para o movimento e Colliders (como a tag "Obstacle") para a deteção de colisões e fim de jogo.

Áudio: Inclui música de fundo contínua e efeitos sonoros para a recolha de itens e colisões.
