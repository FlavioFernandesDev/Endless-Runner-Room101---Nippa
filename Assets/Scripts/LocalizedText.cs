...
internal static class LocalizationTable
{
    private static readonly Dictionary<string, (string english, string portuguese)> Entries = new()
    {
        ...
        ["menu.start_prompt"] = ("CLICK TO PLAY", "CLICA PARA JOGAR"),
        ["menu.game_over_prompt"] = ("CLICK TO PLAY", "CLICA PARA JOGAR"),
        ...
        ["settings.quality.low"] = ("Low", "Baixa"),
        ["settings.quality.medium"] = ("Medium", "Media"),
        ["settings.quality.high"] = ("High", "Alta"),
        ["settings.close"] = ("Close", "Fechar"),
        ["stage.play"] = ("PLAY", "JOGAR"),
        ["stage.room_run"] = ("Room Run", "Corrida do Quarto"),
        ["stage.haunted_hotel"] = ("Haunted Hotel", "Hotel Assombrado"),
